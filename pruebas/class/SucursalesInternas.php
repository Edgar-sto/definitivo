...
class SucursalesInternas
{
            ...
            <div class="col-md-3 " id="multiCollapseExampleEscorza<?php echo $carrier; ?>">
                <div class="card card-body bg-secondary">
                    ...
                    foreach ($campañas_grupos_escorza as $campanias => $grupos) {
                        ...
                        if ( $campanias == "HSBC BT" || $campanias == "HSBC LEC" || $campanias == "HSBC MA" || $campanias == "HSBC PPM" || $campanias == "HSBC SG" || $campanias == "HSBC CON" || $campanias == "HSBC GA" || $campanias == "HSBC AC" || $campanias == "HSBC COM")
                        {
                            $fondobg = "bg-danger";
    ...
    public function consumoRevolucion()
    {
        ...
        $campañas_grupos_revolucion = array(
            ...
            "HSBC CON" => "LAB-CONSUMOS','HSBC-STO-REV-CON-VAL','HSBC-STO-LABREV-COS','HSBC-STO-REV-CONSUMO','ADMIN-ESPECIALSUPERV','ADMIN-ESPECIALCONSUM','HSBC-CONSUMOS",
        ...
        foreach ($all_prefijos as $carrier => $prefijo) {
        ?>
            <div class="col-md-3" id="multiCollapseExampleRevolucion<?php echo $carrier; ?>">
                <div class="card card-body bg-secondary">
                    <label class="fs-5 text-center d-block text-white"><?php echo $carrier; ?></label>
                    <div class="row bg-light border-bottom border-dark text-black text-center">
                        <div class="col-sm-3 border-end border-dark"><strong>Campaña</strong></div>
    ...
    public function consumoTlajomulco()
    {
        ...
        foreach ($all_prefijos as $carrier => $prefijo) {
        ?>
            <div class="col-md-3 " id="multiCollapseExampleTlajomulco<?php echo $carrier; ?>">
                <div class="card card-body bg-secondary">
                    <label class="fs-5 text-center d-block text-white"><?php echo $carrier; ?></label>
                    <div class="row bg-light border-bottom border-dark text-black text-center">
                        <div class="col-sm-3 border-end border-dark"><strong>Campaña</strong></div>
