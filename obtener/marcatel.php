...
//$servidor   =   "47";
$carrier    =   "Marcatel";
//$fe_inicio    =   "2020-12-01";
//$fe_termino     =   "2020-12-31";
            ...
            while ($mostrar_query_campaña   =   mysqli_fetch_assoc($resultado_query_campaña)) {
                ...
                if (empty($campaing)) {
                    ...
                    while ($mostrar_query_sum_drop_buzon   =   mysqli_fetch_assoc($resultado_query_sum_drop_buzon)) {
                        ...
                        echo $insertar_buzon = "INSERT INTO `consumo_telefonia_buzon` (`unique_id`,`reporte`, `prefijo`, `campania`, `consumo_buzon_movil`, `consumo_buzon_fijo`, `fecha_inicio`,`fecha_fin`)
